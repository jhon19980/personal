...
<div class="modal fade" id="modalpdf" tabindex="-1" role="dialog" aria-labelledby="modalpdf" data-backdrop="static" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            <form action="generar_pdf.php" method="post" enctype='multipart/form-data'>
                <div class="modal-header">
                    <h5 class="modal-title" id="modalpdf">CARTA LABORAL</h5>
                </div>
                <div class="container">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">INGRESAR CODI</h3>
                        </div>
