<div class="content">
  <div class="container-fluid">
    <div class="row">
      ...
      if ($tipo == "binaps") {
        $numCorreos = 0;
        $sql = 'SELECT COUNT(*) AS count FROM usuarioxpersonal WHERE usuario_binaps IS NOT NULL AND usuario_binaps != \'\'';
        $stmt = $conexion->prepare($sql);
      ...
      ?>
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h4><?php echo $numCorreos; ?></h4>
              <p>Número de Binaps Registrados</p>
            </div>
            <div class="icon"><i class="fa fa-envelope"></i></div>
            <?php echo ($numCorreos > 0) ? '<a href="#" class="small-box-footer">Más info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
      ...
      ?>
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h4><?php echo count($usuariosFaltantes); ?></h4>
              <p>Usuarios con binaps faltantes</p>
            </div>
            <div class="icon"><i class="fas fa-exclamation-triangle"></i></div>
            <?php
            if (!empty($usuariosFaltantes)) {
      ...
      ?>
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-gris">
            <div class="inner">
              <h4><?php echo count($usuariosFaltantes); ?></h4>
              <p>Usuarios Para Inactivar Binaps</p>
            </div>
            <div class="icon"><i class="fas fa-exclamation-triangle"></i></div>
            <?php
            if (!empty($usuariosFaltantes)) {
      ...
      ?>
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-success">
            <div class="inner">
              <h4><?php echo count($usuariosFaltantes); ?></h4>
              <p>Usuarios para volver a activar el Binaps</p>
            </div>
            <div class="icon"><i class="fas fa-exclamation-triangle"></i></div>
            <?php
            if (!empty($usuariosFaltantes)) {
