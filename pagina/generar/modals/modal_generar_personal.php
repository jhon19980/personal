<div class="modal fade bd-example-modal-xl" id="peractualizar<?php echo $row['id_usuario_personal']; ?>" tabindex="-1" role="dialog" aria-labelledby="peractualizar" data-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="peractualizar">DATOS DEL PERSONAL</h5>
